...
Work Life: I work for Microsoft as a Cloud Solution Arhitect, specializeding in helping customers navigate how to transform their businesses to use [Microsoft Azure](https://azure.microsoft.com), our cloud computing platform. Previous to making a jump to the "New Microsoft", I spent a decade in the datacenter virtualization space working as virtualization engineer, IT manager, solution architect, consultant, and principle architect on multiple private cloud projects. Started work life as a programmer in a dead language (IDML on a VMS environment), open source web developer and small business network admin.  
